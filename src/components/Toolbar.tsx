...
import { Home, ChevronRight, PanelLeft, PanelLeftClose, Terminal, Command, MoreVertical, List, Grid2X2, SortAsc, SortDesc } from 'lucide-react';
import { sidebarCollapsedAtom, currentPathAtom, terminalOpenAtom, commandPaletteOpenAtom, fileViewModeAtom, fileSortModeAtom, fileSortOrderAtom } from '@/store/atoms';
