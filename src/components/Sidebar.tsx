...
import { Home, Monitor, FileText, Download, Image, Video, Settings, Star, Cloud } from 'lucide-react';
import { sidebarCollapsedAtom, currentPathAtom, pinnedFoldersAtom, cloudProvidersAtom } from '@/store/atoms';
...
const Sidebar = () => {
  ...
  const quickAccessItems = [
    ...
    { name: 'Desktop', path: '/home/user/Desktop', icon: Monitor, color: 'text-purple-500' },
    { name: 'Documents', path: '/home/user/Documents', icon: FileText, color: 'text-green-500' },
    { name: 'Downloads', path: '/home/user/Downloads', icon: Download, color: 'text-orange-500' },
    { name: 'Pictures', path: '/home/user/Pictures', icon: Image, color: 'text-rose-500' },
    { name: 'Videos', path: '/home/user/Videos', icon: Video, color: 'text-indigo-500' },
  ];
